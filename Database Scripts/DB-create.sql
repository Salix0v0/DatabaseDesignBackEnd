...
CREATE TABLE C##CAR.STAFF_INFORMATION (
    ...
    GENDER CHAR(1) CHECK (GENDER IN ('f', 'm')),
    CONSTRAINT FK_STAFF_STAFF_INFORMATION FOREIGN KEY (IDENTITY_NUMBER)
        REFERENCES C##CAR.STAFF (IDENTITY_NUMBER)
);
CREATE TABLE C##CAR.SWITCH_REQUESTS (
    SWITCH_REQUEST_ID VARCHAR2(50) PRIMARY KEY,
    VEHICLE_ID VARCHAR2(50) NOT NULL,
    SWITCH_MODE CHAR(1) CHECK (AVAILABLE_STATUS IN ('D', 'L')),
